...
<div class="container  p-3 mb-5 text-white" role="main">
	<h1 align="center">예약을 정말 취소하시겠습니까?</h1>
	<div class="container">
	<form method="POST" action="cancle_R.jsp">
  		...
  		<button type="button" class="btn btn-primary" onclick = "location.href = 'Home.jsp'">아니오</button>
  		</div>
	</form>
